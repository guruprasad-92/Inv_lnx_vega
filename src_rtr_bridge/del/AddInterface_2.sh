...
#Try to connect to data
        ...
        /legato/systems/current/apps/SIMTestApp/read-only/bin/SIMTestAppComponentExe 2>&1 &
		...
		#	sleep 5
		#	CurrentDate=$(date +"%Y-%m-%d %H:%M:%S")
		#	mosquitito_pub -d -t "Isensev2/SimSwitch/CommandRequest" -m "<,1,SELSIM1,$CurrentDate,>"
        fi
